COMMIT_MESSAGES = {
    ...
    "lazy": [
        "Just wanted to finish this and go to sleep.",
        "Why write tests when you can just hope for the best?",
        "The code works... I think. I’ll check tomorrow.",
        "This commit is the bare minimum. You’re welcome.",
    ],
    "chaotic": [
    ...
    "detail-oriented": [
        "Made sure every variable is named perfectly. That’s how you write quality code.",
        "Reformatted the entire codebase because I care about spacing.",
        "Fixed that one tiny bug that no one would have noticed.",
        "I made everything beautiful. It’s a work of art.",
    ],
    "overwhelmed": [
